...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <flux:header container class="border-b border-zinc-200 bg-white
        dark:border-zinc-700 dark:bg-zinc-900">
            ...
            space-x-2 rtl:space-x-reverse lg:ms-0" wire:navigate>
                <x-app-logo />
            </a>
            ...
            <flux:dropdown position="top" align="end">
                ...
                <flux:menu>
                    ...
                    <flux:menu.radio.group>
                        <flux:menu.item href="/my-orders" icon="shopping-bag" wire:navigate>{{ __('My Orders') }}</flux:menu.item>
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route('home') }}" class="ms-1 flex items-center
            space-x-2 rtl:space-x-reverse" wire:navigate>
                <x-app-logo />
            </a>
